...
public class Popup_ListModel {

    private String  rates, qtys, taxs, gsts, discounts, mrps,c_names,p_names;

    public Popup_ListModel(String rates, String qtys, String taxs, String gsts, String discounts, String mrps, String c_names, String p_names) {
        this.rates = rates;
        this.qtys = qtys;
        this.taxs = taxs;
        this.gsts = gsts;
